...
df = pd.read_csv('data_bottom.csv', encoding='utf-8')
...
features_center = ['Коэффициент ликвидности (Н3%)', 'Норматив достаточности капитала (Н1) (log)',
                   'Доля просроченных кредитов (NPL%)', 'Размер банка (лог активов)', ]
...
X_test_logit = sm.add_constant(X_test[['Коэффициент ликвидности (Н3%)', 'Норматив достаточности капитала (Н1) (log)', 'Доля просроченных кредитов (NPL%)', 'Размер банка (лог активов)', ]])
