...
df = pd.read_csv('data_fall.csv', encoding='utf-8')
...
features_log = ['Темп прироста ВВП',
...
features_center = ['Норматив достаточности капитала (Н1) (log)', 'Рентабельность активов (ROA%)', 'Размер банка (лог активов)', 'Доля банка в активах системы']
...
X_test_logit = sm.add_constant(X_test[['Норматив достаточности капитала (Н1) (log)', 'Рентабельность активов (ROA%)', 'Размер банка (лог активов)', 'Доля банка в активах системы']])
